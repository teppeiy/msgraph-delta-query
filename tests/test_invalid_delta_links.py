...
class TestInvalidDeltaLinkHandling:
    ...
    async def test_stored_invalid_deltatoken_triggers_fallback(self):
        ...
        try:
            ...
            await storage.set("applications", invalid_delta_link, {
    ...
    async def test_stored_invalid_delta_link_fallback(self):
        ...
        await storage.set("test_applications", invalid_delta_link, {"test": "stored_invalid"})
    ...
    async def test_stored_invalid_delta_link_no_fallback(self):
        ...
        # Store the invalid delta link
        await storage.set("test_applications_no_fallback", invalid_delta_link, {"test": "stored_invalid_no_fallback"})
        ...
        for i, test_case in enumerate(test_cases):
            ...
            try:
                ...
                if metadata.change_summary.timestamp:
                    print(f"   📅 Incremental sync (since: {metadata.change_summary.timestamp})")
                else:
                    print(f"   📅 Full sync")
