...
class TestClientComprehensiveCoverage:
    ...
    async def test_storage_info_logging_azure_blob_with_connection_string(self):
        ...
        mock_storage._connection_string = "DefaultEndpointsProtocol=https;AccountName=testconn;AccountKey=key123"
    ...
    async def test_extract_skiptoken_from_url_edge_cases(self):
        ...
        result = client._extract_skiptoken_from_url("https://example.com/api?$skiptoken=abc123")
